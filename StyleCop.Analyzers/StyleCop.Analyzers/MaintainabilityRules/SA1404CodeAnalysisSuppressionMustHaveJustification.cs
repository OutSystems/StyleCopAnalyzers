...
namespace StyleCop.Analyzers.MaintainabilityRules
{
    ...
    internal class SA1404CodeAnalysisSuppressionMustHaveJustification : DiagnosticAnalyzer
    {
        ...
        private const string HelpLink = "https://github.com/brunocunhasilva/StyleCopAnalyzers/blob/master/documentation/SA1404.md";
        ...
        private static void HandleCompilationStart(CompilationStartAnalysisContext context)
        {
            ...
            context.RegisterSyntaxNodeActionWithExclusionsVerification(instance.HandleAttributeNode, SyntaxKind.Attribute);
        }
