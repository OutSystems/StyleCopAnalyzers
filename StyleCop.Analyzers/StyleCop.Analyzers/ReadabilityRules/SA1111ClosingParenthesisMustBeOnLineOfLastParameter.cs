...
namespace StyleCop.Analyzers.ReadabilityRules
{
    ...
    internal class SA1111ClosingParenthesisMustBeOnLineOfLastParameter : DiagnosticAnalyzer
    {
        ...
        private static readonly string HelpLink = "https://github.com/brunocunhasilva/StyleCopAnalyzers/blob/master/documentation/SA1111.md";
        ...
        public override void Initialize(AnalysisContext context)
        {
            ...
            context.RegisterSyntaxNodeActionWithExclusionsVerification(BaseMethodDeclarationAction, HandledMethodSyntaxKinds);
