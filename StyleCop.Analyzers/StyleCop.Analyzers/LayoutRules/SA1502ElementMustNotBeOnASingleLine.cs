...
namespace StyleCop.Analyzers.LayoutRules
{
    ...
    internal class SA1502ElementMustNotBeOnASingleLine : DiagnosticAnalyzer
    {
        ...
        private static readonly string HelpLink = "https://github.com/brunocunhasilva/StyleCopAnalyzers/blob/master/documentation/SA1502.md";
        ...
        public override void Initialize(AnalysisContext context)
        {
            ...
            context.RegisterSyntaxNodeActionWithExclusionsVerification(BaseMethodDeclarationAction, SyntaxKinds.BaseMethodDeclaration);
